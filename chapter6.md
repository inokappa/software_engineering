# 6. モデル化技法と UML
<!--ts-->
   * [6. モデル化技法と UML](#6-モデル化技法と-uml)
      * [はじめに](#はじめに)
      * [1. ソフトウェアのモデル](#1-ソフトウェアのモデル)
         * [(1) モデルとは](#1-モデルとは)
         * [(2) モデルを作成する目的](#2-モデルを作成する目的)
         * [(3) さまざまなモデル](#3-さまざまなモデル)
      * [2. モデル記述](#2-モデル記述)
         * [(1) グラフ表現](#1-グラフ表現)
         * [(2) UML](#2-uml)
         * [(3) 形式モデル](#3-形式モデル)
      * [3. モデル分析とモデル変換](#3-モデル分析とモデル変換)
         * [(1) 模擬実行](#1-模擬実行)
         * [(2) モデル検査](#2-モデル検査)
         * [(3) モデル洗練と正しさの証明](#3-モデル洗練と正しさの証明)
         * [(4) モデル駆動開発とモデル変換](#4-モデル駆動開発とモデル変換)
      * [参考](#参考)

<!-- Added by: kappa, at: 2018-05-13T08:48+09:00 -->
