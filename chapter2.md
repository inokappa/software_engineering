...
<!--ts-->
   * [2. ソフトウェアの不具合がもたらす社会的影響](#2-ソフトウェアの不具合がもたらす社会的影響)
      ...
      * [3. 安全性や信頼性に関する用語と概念](#3-安全性や信頼性に関する用語と概念)
         * [(1) エラーの用語](#1-エラーの用語)
         * [(2) 依存可能性 (dependability)](#2-依存可能性-dependability)
      * [4. リスク対策](#4-リスク対策)
         * [(1) リスク管理](#1-リスク管理)
         * [(2) 耐障害性と故障安全システム](#2-耐障害性と故障安全システム)
      * [参考リンク](#参考リンク)

<!-- Added by: kappa, at: 2018-04-15T17:23+09:00 -->
